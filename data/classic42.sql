...
CREATE TABLE  orderdetails  (
   ...
   orderLineNumber  char(6) NOT NULL,
...
('S12_3148','1969 Corvair Monza','Classic Cars','1:18','Welly Diecast Productions','1:18 scale die-cast about 10in long doors open, hood opens, trunk opens and wheels roll',6906,'89.14','151.08'),
...
('S12_4473','1957 Chevy Pickup','Trucks and Buses','1:12','Exoto Designs','1:12 scale die-cast about 20in long Hood opens, Rubber wheels',6125,'55.70','118.50'),
...
('S24_1444','1970 Dodge Coronet','Classic Cars','1:24','Highway 66 Mini Classics','1:24 scale die-cast about 18in long doors open, hood opens and rubber wheels',4074,'32.37','57.80'),
...
('S700_2610','The USS Constitution Ship','Ships','1:700','Red Start Diecast','All wood with canvas sails. Measures 31 1/2in Length x 22 3/8in High x 8 1/4in Width. Extras include 4 boats on deck, sea sprite on bow, anchors, copper railing, pilot houses, etc.',7083,'33.97','72.28'),
('S700_2824','1982 Camaro Z28','Classic Cars','1:18','Carousel DieCast Legends','Features include opening and closing doors. Color: White. Measures approximately 9 1/2in Long.',6934,'46.53','101.15'),
...
('S700_3167','F/A 18 Hornet 1/72','Planes','1:72','Motor City Art Classics','10in Wingspan with retractable landing gears.Comes with pilot',551,'54.40','80.00'),
